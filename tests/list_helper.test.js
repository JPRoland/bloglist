...
describe('total likes', () => {
  ...
  test('Returns total likes for a list of blogs', () => {
...
describe('favorite blog', () => {
  ...
  test('Returns blog with most likes', () => {
    const result = listHelper.favoriteBlog(blogs.slice(0, blogs.length - 1))
    expect(result).toEqual([blogs[2]])
  })

  test('Returns an array of blogs with most likes', () => {
